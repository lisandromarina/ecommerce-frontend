...
function CheckoutComponent(props) {
            ...
            <Card>
                ...
                <Card.Body className='card-body-wrapper'>
                    ...
                    <Card.Body className='card-body-links'>
                        ...
                        <Card.Link onClick={() => console.log(address)}>Editar</Card.Link>
                    </Card.Body>
                </Card.Body>
            </Card>
        );
    ...
    //I should create a new component but first I must restructure the folder architecture for features
    const MyAddressCards = ({ allAddresses, handleOnCancel, handleOnCreate }) => {
        return (
            <>
    ...
    //I should create a new component but first I must restructure the folder architecture for features
    const ShippingAddress = ({ address, handleOnMyAddress, isLoading, handleOnCheckout }) => {
        return (
            <>
