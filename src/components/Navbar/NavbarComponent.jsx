                ...
                <div className='d-flex justify-content-around w-100 text-white mt-1'>
                    {
                        allCategory.map(oneCategory => (
                            <div className="mt-1">
                                ...
                                <div onClick={handleOnClickCategory} className='d-block d-sm-block d-md-block d-lg-none'>{oneCategory.name}</div>
                            </div>
                        ))
                    }
                    {/* <div onClick={handleOnClickCategory} className='m-auto d-none d-lg-block'>Technologia</div>
                    <div onClick={handleOnClickCategory} className='d-block d-sm-block d-md-block d-lg-none'>Technologia</div>
                    <div onClick={handleOnClickCategory} className='m-auto d-none d-lg-block'>Hogar y muebles</div>
                    <div onClick={handleOnClickCategory} className='d-block d-sm-block d-md-block d-lg-none'> Hogar </div>
                    <div onClick={handleOnClickCategory} className='m-auto d-none d-lg-block'>Ropa y accesorios</div>
                    <div onClick={handleOnClickCategory} className='d-block d-sm-block d-md-block d-lg-none'> Ropa </div>
                    <div onClick={handleOnClickCategory} className='m-auto d-none d-lg-block'>Salud y belleza</div>
                    <div onClick={handleOnClickCategory} className='d-block d-sm-block d-md-block d-lg-none'> Salud </div>
                    <div onClick={handleOnClickCategory} className='m-auto d-none d-lg-block'>Entretenimiento</div>
                    <div onClick={handleOnClickCategory} className='d-block d-sm-block d-md-block d-lg-none'> Diversion </div> */}
                </div>
            </Container>
        </Navbar>
    )
