        ...
        <Navbar expand="lg" className='d-flex flex-column'>
            <Container className='d-flex flex-column'>
                <div className='w-100 d-flex align-items-center justify-content-around'>
                    <Image className="text-center col-4 col-lg-2 text-white"
            ...
            <Container className='col col-md-7  mx-auto d-flex justify-content-center'>
                <div className='d-flex justify-content-around w-100 text-white mt-1'>
                    <div className='m-auto d-none d-lg-block'>Technologia</div>
                    <div className='d-block d-sm-block d-md-block d-lg-none'>Technologia</div>
                    <div className='m-auto d-none d-lg-block'>Hogar y muebles</div>
                    <div className='d-block d-sm-block d-md-block d-lg-none'> Hogar </div>
                    <div className='m-auto d-none d-lg-block'>Ropa y accesorios</div>
                    <div className='d-block d-sm-block d-md-block d-lg-none'> Ropa </div>
                    <div className='m-auto d-none d-lg-block'>Salud y belleza</div>
                    <div className='d-block d-sm-block d-md-block d-lg-none'> Salud </div>
                    <div className='m-auto d-none d-lg-block'>Entretenimiento</div>
                    <div className='d-block d-sm-block d-md-block d-lg-none'> Diversion </div>
                </div>
            </Container>
        </Navbar>
    )
